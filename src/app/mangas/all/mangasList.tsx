export default function MangasList(props: props) {
  ...
  return (
      <div className="flex flex-col flex-wrap xl:p-8 bg-blue-950 w-11/12 max-xl:w-screen mx-auto max-lg:mx-2 mt-28 mb-8 xl:rounded-xl max-sm:p-0 max-sm:rounded-none">
